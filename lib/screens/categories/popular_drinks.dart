...
class PopularDrinks extends StatefulWidget {
  const PopularDrinks({Key? key}) : super(key: key);

  @override
  _PopularDrinksState createState() => _PopularDrinksState();
}

class _PopularDrinksState extends State<PopularDrinks> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: StreamBuilder<QuerySnapshot>(
            stream: categoryListProvider.fetchDrinksCategory(),
