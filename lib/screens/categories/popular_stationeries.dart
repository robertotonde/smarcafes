...
class PopularStationeries extends StatefulWidget {
  const PopularStationeries({Key? key}) : super(key: key);

  @override
  _PopularStationeriesState createState() => _PopularStationeriesState();
}

class _PopularStationeriesState extends State<PopularStationeries> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: StreamBuilder<QuerySnapshot>(
            stream: categoryListProvider.fetchStationeryCategory(),
