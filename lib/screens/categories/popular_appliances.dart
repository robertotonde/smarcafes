...
class PopularAppliances extends StatefulWidget {
  const PopularAppliances({Key? key}) : super(key: key);

  @override
  _PopularAppliancesState createState() => _PopularAppliancesState();
}

class _PopularAppliancesState extends State<PopularAppliances> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: StreamBuilder<QuerySnapshot>(
            stream: categoryListProvider.fetchAppliancesCategory(),
