...
class TigoPesaCheckoutScreen extends StatefulWidget {
  const TigoPesaCheckoutScreen({
    Key? key,
  }) : super(key: key);

  @override
  _TigoPesaCheckoutScreenState createState() => _TigoPesaCheckoutScreenState();
}

class _TigoPesaCheckoutScreenState extends State<TigoPesaCheckoutScreen> {
  bool isLoading = false;
  late Orders orderProvider;
  final _phoneController = TextEditingController();
  bool hasPaid = false;
  String provider = "Tigo";
  String referenceid = "";
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  child: Text(
                      "Enter Tigo number that you want to make payment with and check the total amount that you have to pay. Click PAY & ORDER and a TigoPesa  dialog will appear on your device (number entered) enter your TigoPesa  pin to verify your payment. Thereafter, your order will be processed ASAP 😋",
