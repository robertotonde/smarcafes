...
class CashCheckoutScreen extends StatefulWidget {
  ...
  @override
  _CashCheckoutScreenState createState() => _CashCheckoutScreenState();
}
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  child: Text(
                      "Enter number that we can reach you out for payment. Once payment is done(CASH) your order will be process and delivered ASAP.",
