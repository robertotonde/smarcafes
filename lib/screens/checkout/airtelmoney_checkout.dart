...
class AirtelMoneyCheckoutScreen extends StatefulWidget {
  const AirtelMoneyCheckoutScreen({
    Key? key,
  }) : super(key: key);

  @override
  _AirtelMoneyCheckoutScreenState createState() =>
      _AirtelMoneyCheckoutScreenState();
}

class _AirtelMoneyCheckoutScreenState extends State<AirtelMoneyCheckoutScreen> {
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  child: Text(
                      "Enter Airtel number that you want to make payment with and check the total amount that you have to pay. Click PAY & ORDER and a Airtel Money  dialog will appear on your device (number entered) enter your Airtel Money  pin to verify your payment. Thereafter, your order will be processed ASAP 😋",
                                                                          ...
                                                                          onPressed: isLoading == true
                                                                              ...
                                                                              : () async {
                                                                                  ...
                                                                                  if (userNumber == '') {
                                                                                    ...
                                                                                    ChargeResponse? chargeResponse = await shoket.charge(Payment(amount: total.toString(), customerName: deliverySnapshot.userName, email: deliverySnapshot.email, numberUsed: userNumber, channel: "Airtel"));
