...
class HalopesaCheckoutScreen extends StatefulWidget {
  const HalopesaCheckoutScreen({
    Key? key,
  }) : super(key: key);

  @override
  _HalopesaCheckoutScreenState createState() => _HalopesaCheckoutScreenState();
}

class _HalopesaCheckoutScreenState extends State<HalopesaCheckoutScreen> {
  bool isLoading = false;
  late Orders orderProvider;
  final _phoneController = TextEditingController();
  bool hasPaid = false;
  String provider = "Halotel";
  String referenceid = "";
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  child: Text(
                      "Enter Halotel number that you want to make payment with and check the total amount that you have to pay. Click PAY & ORDER and a HaloPesa  dialog will appear on your device (number entered) enter your HalotelPesa  pin to verify your payment. Thereafter, your order will be processed ASAP 😋",
                                                                          ...
                                                                          onPressed: isLoading == true
                                                                              ...
                                                                              : () async {
                                                                                  ...
                                                                                  if (userNumber == '') {
                                                                                    ...
                                                                                    ChargeResponse? chargeResponse = await shoket.charge(Payment(amount: total.toString(), customerName: deliverySnapshot.userName, email: deliverySnapshot.email, numberUsed: userNumber, channel: "Halotel"));
